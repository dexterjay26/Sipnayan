...
class LeaderBoardsSingleScreen2 extends StatefulWidget {
  static const routeName = "/leaderboard";
  final type;
  LeaderBoardsSingleScreen2(this.type);

  @override
  _LeaderBoardsSingleScreen2State createState() =>
      _LeaderBoardsSingleScreen2State();
}

class _LeaderBoardsSingleScreen2State extends State<LeaderBoardsSingleScreen2> {
